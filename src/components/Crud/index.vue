  ...
  <div style="padding-top: 14px">
    ...
    <div v-if="!hideSearch" class="search">
      ...
      <div style="display: inline-block">
        ...
        <el-button plain icon="el-icon-refresh" @click="resetSearch">重置</el-button>
      </div>
    ...
    <div v-if="dialogDestroyOnClose ? dialog : true">
      ...
      >
        <div>
          <el-form ref="form" :model="form" :rules="rule" :label-width="labelWidth" label-suffix=":">
            <!--表单插槽-->
            <slot name="form"></slot>
          </el-form>
        </div>
        <div v-if="!hideDialogAction" slot="footer">
          ...
          <el-button v-if="!hideSave" type="primary" :loading="loading" @click="saveItem">{{ determineText }}
          </el-button>
          <!--表单操作插槽-->
    ...
    async getItems() {
      ...
      try {
        if (this.customGetMethod) {
          ...
          this.items = res.records || res.rows || res.data;
