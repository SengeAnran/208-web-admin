...
<!--          </el-col>-->
        ...
        <!--        </el-button-group>-->
        <!--      </el-row>-->
        <Content :info="info" @getDetail="getDetailInfo"></Content>
...
import {editOne, exportSingle, getDetail, reAnalysis} from "@/api/SpecialReport.js";
...
export default {
  ...
  methods: {
    ...
    // 保存
    handleSave() {
      const {id, contents, title, tips} = this.info;
